...
+ (CGFloat)titleWidth:(NSString *)str {
    CGRect rect = [str boundingRectWithSize:CGSizeMake(MAXFLOAT, 30) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : [UIFont systemFontOfSize:14.0 weight:UIFontWeightThin]} context:nil];
