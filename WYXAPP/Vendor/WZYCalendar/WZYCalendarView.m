...
- (UIView *)setupCalendarHeaderWithFrame:(CGRect)frame {
    ...
    [yearMonthButton setTitleColor:HEXCOLOR(0xE066FF) forState:UIControlStateNormal];
    ...
    [todayButton setTitle:@"T" forState:UIControlStateNormal];
    [todayButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    todayButton.backgroundColor = HEXCOLOR(0xE066FF);
...
- (void)refreshToCurrentMonthAction:(UIButton *)sender {
    ...
    NSString *title = [NSString stringWithFormat:@"%d.%d", (int)year, (int)month];
...
- (void)changeCalendarHeaderAction:(NSNotification *)sender {
    ...
    NSString *title = [NSString stringWithFormat:@"%@.%@", year, month];
